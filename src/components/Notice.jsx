    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40">
      <div className="relative backdrop-blur-sm bg-white/60 border border-white/30 rounded-2xl shadow-2xl w-11/12 max-w-sm p-6 text-center">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-md font-geom text-gray-700">Now Customers with outstanding credit or airtime debts, please note that data may not reflect at your end even after been deducted for MTN data .Hence we encourage you to settle your debts before placing orders.
</div>
